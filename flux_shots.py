...
SHOTS = {
  ...
  "hero-bottle": (
    ...
    "minimalist clean white label, standing on a soft blush pink seamless studio backdrop, "
    ...
    "text, letters, watermark, logo, clutter, hands, people, busy background",
    1024, 1280),
  "squeeze-lifestyle": (
...
def main():
    ...
    flux = [c for c in ckpt if "flux" in c][0]
    for name,(pos,neg,w,h) in shots.items():
        g = {
          ...
          "3": {"class_type":"KSampler","inputs":{"seed":random.randint(1,10**9),"steps":28,"cfg":1.0,
